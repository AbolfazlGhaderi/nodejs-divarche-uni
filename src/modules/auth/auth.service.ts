...
export class AuthService implements IAuthService {
  ...
  async LoginPost(loginData: LoginDto, req: express.Request, res: express.Response) {
    ...
    return this.SaveAndSendOtpLogin(phoneNumber, key, req, res);
  }

  async SaveAndSendOtpLogin(phoneNumber: string, key: string, req: express.Request, res: express.Response) {
    // Generate Otp
